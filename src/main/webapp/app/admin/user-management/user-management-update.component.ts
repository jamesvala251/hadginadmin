...
export class UserManagementUpdateComponent implements OnInit {
  ...
  private updateUser(user: User): void {
    ...
    user.userGroup = this.editForm.get(['userGroup'])!.value;
    this.userGroupService.find(this.editForm.get(['userGroup'])!.value).subscribe(resp => {
      alert(resp.body?.groupName);
      user.userGroupName = resp.body?.groupName;
      if (this.user.id !== undefined) {
