...
To build the final jar and optimize the UserManagementFE application for production, run:
...
For example, to start a nosql database in a docker container, run:

    docker-compose -f src/main/docker/nosql.yml up -d

To stop it and remove the container, run:

    docker-compose -f src/main/docker/nosql.yml down
